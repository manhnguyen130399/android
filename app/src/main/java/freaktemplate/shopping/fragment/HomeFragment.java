...
import freaktemplate.shopping.activity.OfferActivity;
import freaktemplate.shopping.activity.SearchActivity;
import freaktemplate.shopping.adapter.ItemListAdapter;
import freaktemplate.shopping.adapter.MainOfferAdapter;
import freaktemplate.shopping.adapter.ProductOfferAdapter;
import freaktemplate.shopping.getset.Wish.WishPojo;
import freaktemplate.shopping.getset.bestseling.BestSellingpojo;
import freaktemplate.shopping.getset.bestseling.Data;
import freaktemplate.shopping.getset.bestseling.Datum;
import freaktemplate.shopping.getset.notification.Tokendata;
import freaktemplate.shopping.getset.offerlist.Offer;
import freaktemplate.shopping.getset.offerlist.Offerpojjo;
...
import static freaktemplate.shopping.activity.HomeActivity.ic_cart;
import static freaktemplate.shopping.activity.HomeActivity.ic_favrite;
import static freaktemplate.shopping.activity.HomeActivity.ic_home;
import static freaktemplate.shopping.activity.HomeActivity.ic_user;
import static freaktemplate.shopping.activity.HomeActivity.rel_cart;
import static freaktemplate.shopping.activity.HomeActivity.rel_favorite;
import static freaktemplate.shopping.activity.HomeActivity.rel_home;
import static freaktemplate.shopping.activity.HomeActivity.rel_user;
import static freaktemplate.shopping.activity.HomeActivity.txt_cart;
import static freaktemplate.shopping.activity.HomeActivity.txt_cartitem;
import static freaktemplate.shopping.activity.HomeActivity.txt_favrite;
import static freaktemplate.shopping.activity.HomeActivity.txt_home;
import static freaktemplate.shopping.activity.HomeActivity.txt_user;
